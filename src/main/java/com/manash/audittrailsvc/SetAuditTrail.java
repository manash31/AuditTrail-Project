package com.manash.audittrailsvc;
...
public class SetAuditTrail implements JavaDelegate {
    private final Logger logger = LoggerFactory.getLogger(SetAuditTrail.class);
    ...
    public void execute(DelegateExecution execution) throws Exception{
        ...
        String TopicName = "Camunda-AuditTrail-events";// (String) execution.getVariable("Camunda-AuditTrail-events");
        if(TopicName.equals("")){
